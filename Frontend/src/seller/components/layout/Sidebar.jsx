...
// Keep only the menu items required for the seller panel
export const menuItems = [
  { path: "/seller", name: "Dashboard", icon: FiGrid },
  { path: "/seller/products", name: "Products", icon: FiShoppingBag },
  { path: "/seller/inventory", name: "Inventory", icon: FiTag },
  { path: "/seller/orders", name: "Orders", icon: FiTrendingUp },
  { path: "/seller/customers", name: "Customers", icon: FiUser },
  { path: "/seller/reviews", name: "Reviews", icon: FiStar },
  { path: "/seller/profile", name: "Profile", icon: FiUser },
];
